# Blacklace Island — registre des lieux v0.1 (inventaire, pas carte géographique)
...
| --- | --- | --- | --- | --- | --- | --- |
| beach-bar | Bar de la plage / Max Liberty à rapprocher | Max, accueil | Benoît ; Lieux ; Bible | oui | non auditée | non auditée |
| seawall | Digue et peintures de Marty / route côtière à rapprocher | Marty, art et indices | Benoît ; Lieux | oui | non auditée | non auditée |
...
| belette-waterfall | Cascade de la Fée Belette | Fée Belette | Benoît | oui | non auditée | non auditée |
...
| sator-dolmens | Dolmens SATOR | mystère, archives | Benoît ; Bible | oui | non auditée | non auditée |
...
Ne pas injecter les 21 entrées dans `PlaceId` par simple extension : le graphe S-001 ne possède que neuf nœuds de simulation abstraits. Valider d'abord les équivalences et les chemins. Ne pas rendre publics les secrets narratifs via le bundle client. Les statuts de paiement, d'accès premium et de NFT restent non vérifiés.
...
4. Proposer une carte de voisinage séparée et soumise à Benoît avant modification du moteur.
